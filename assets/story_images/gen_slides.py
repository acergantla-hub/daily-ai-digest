...
stories = [
    ("slide_1.png", "Nobel Laureate\nJohn Jumper\nLeaves DeepMind\nfor Anthropic", "anthropic.jpg"),
    ("slide_2.png", "Signal CEO:\nAI Chatbots\n'Are Not\nYour Friends'", None),
    ("slide_3.png", "Baseten Raising\n$1.5B for AI\nInference", "baseten.png"),
    ("slide_4.png", "Snap Spins Off\nAI Video Team\ninto Dotmo", "snap_dotmo.png"),
    ("slide_5.png", "Elastic Buys\nDeductive AI\nfor $85M", None),
    ("slide_6.png", "Pentagon Uses\nAI to Write\nCongress Reports", "pentagon_ai.png"),
]
